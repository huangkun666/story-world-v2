...
const TEST_MAP = {
    ...
    'gate.js': ['gate.test.js', 'weight-smoke.test.js', 'birth.test.js', 'entity-governance.test.js'],
    'transport-config.js': ['transport-config.test.js', 'browser-compat.test.js'],
    'abstract.js': ['abstract.test.js', 'browser-compat.test.js', 'entity-governance.test.js', 'abstract-chunk.test.js'],
    'init-source.js': ['init-source.test.js'],
