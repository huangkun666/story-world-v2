...
const TEST_MAP = {
    ...
    'check-step.js': ['worldstep.test.js', 'birth.test.js'],
    'worldstep.js': ['worldstep.test.js'],
    'settle.js': ['settle.test.js', 'golden-slice.test.js', 'gate.test.js', 'cause.test.js', 'decay.test.js', 'weight-smoke.test.js', 'birth.test.js', 'verdict.test.js', 'event-close.test.js', 'archive.test.js', 'shade.test.js', 'cancel.test.js', 'snapshot-replay.test.js'],
