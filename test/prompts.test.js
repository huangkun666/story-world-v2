...
test('契约锁：主调用模板版本与铁律语义（v2-agenda-t1-13：leg32h 陈旧死链头过滤/并行 + 主角认领 + leg32g 待启用名单 + leg32e 新人出场权 + leg32d 七组必填/点名解锁 + leg32c 长跑接得上 + leg31 实体段行式表格 + leg29 波及上限告知面 + 分量退场 + leg25 c 七组形状）', () => {
    assert.equal(MAIN_PROMPT_V, 'v2-agenda-t1-14');
